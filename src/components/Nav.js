    ...
    return (
        <>
            ...
            <div className="footer-container">
              ...
              <a href ="https://www.twitter.com" target="_blank" rel="noreferrer noopener"><img className="nav-icon" src ={TwitterLogo} alt ="twitter logo"></img></a>
              <a href ="https://www.instagram.com" target="_blank" rel="noreferrer noopener"><img className="nav-icon" src ={InstagramLogo} alt ="instagram logo"></img></a>
              </div>
            <footer>
