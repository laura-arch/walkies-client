...
function Doggo() {
    ...
    return (
        ...
        <div className="content">
            <img className="hero-image" src="https://i0.wp.com/ohmydogblog.com/wp-content/uploads/2010/03/Emmett.jpg?w=1200&ssl=1" alt="Dog"></img>
            <div>
                <h1>Emmett</h1>
                <h2>Breed: Beagle</h2>
                <h2>Age: 7</h2>
            ...
            <Link to={`/messages/`}><button>Message me 🐾</button></Link>
        </>
    )
}
